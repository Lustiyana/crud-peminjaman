<div class="main-panel">
							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										...
										<a href="?view=createpinjamambulance" class="btn btn-primary btn-round ml-auto">
								...
								<div class="card-body">
									<div class="table-responsive">
										<table id="add-row" class="display table table-striped table-hover" >
											...
											<tbody>
												...
												?>
												<?php if($_SESSION['id'] == $pinjamambulance['id_user']) { ?>
												<tr>
													<td><?php echo $no++ ?></td>
													...
													<td>
														...
														<a href="#modalHapusPinjamAmbulance<?php echo $pinjamambulance['id'] ?>" data-toggle="modal" title="Batal Pinjam" class="btn btn-xs btn-danger"><i class="fa fa-trash"></i> Batal</a>
													<?php }elseif($pinjamambulance['status'] == 'approve') { ?>
														<a href="?view=detailpinjamambulance&id=<?php echo $pinjamambulance['id'] ?>" title="Detail" class="btn btn-xs btn-success"><i class="fa fa-eye"></i></a>
														<a href="#modalKembalikanPinjamAmbulance<?php echo $pinjamambulance['id'] ?>" data-toggle="modal" title="Batal Pinjam" class="btn btn-xs btn-danger"><i class="fa fa-trash"></i> Kembalikan</a>
													<?php }else { ?>
														<a href="?view=detailpinjamambulance&id=<?php echo $pinjamambulance['id'] ?>" title="Detail" class="btn btn-xs btn-success"><i class="fa fa-eye"></i></a>
														<div class="badge badge-success"><?php echo $pinjamambulance['status'] ?></div>
													<?php } ?>
									...
									<div class="modal fade" id="modalHapusPinjamAmbulance<?php echo $row['id'] ?>" tabindex="-1" role="dialog" aria-hidden="true">
									...
									<div class="modal fade" id="modalKembalikanPinjamAmbulance<?php echo $row['id'] ?>" tabindex="-1" role="dialog" aria-hidden="true">
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												<div class="modal-header no-bd">
													<h5 class="modal-title">
		...
		<?php 
			if(isset($_POST['hapus']))
			{
		        ...
		        mysqli_query($conn,"DELETE from pinjamambulance where id='$id'");
		        echo "<script>alert ('Data Berhasil Dihapus') </script>";
                echo"<meta http-equiv='refresh' content=0; URL=?view=datapinjamambulance>";
