...
<body>
	<div class="wrapper">
		...
		<?php
					...
					// Data Pinjam Ambulance
                    elseif($_GET['view']=='datapinjamambulance')
                        include 'peminjaman/ambulance/datapinjamambulance.php';

                    elseif($_GET['view']=='createpinjamambulance')
                        include 'peminjaman/ambulance/createpinjamambulance.php';
                    ...
                    elseif($_GET['view']=='datapinjammobil')
                        include 'peminjaman/mobil/datapinjammobil.php';

                    elseif($_GET['view']=='createpinjammobil')
                        include 'peminjaman/mobil/createpinjammobil.php';
